...
<tr><td style="font-size:24px; color:#F00; font-weight:bold">Admin Action</td></tr>
<br />
<?php if($_SESSION["usertype"]=="Admin")
{?>
<tr><td class="lefttd"><a href="adduser.php">Add User</a></td>
<td class="lefttd"><a href="upuser.php">Update User</a></td>
