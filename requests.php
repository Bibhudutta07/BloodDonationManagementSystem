...
<tr><td class="lefttd" align="center"> Name:</td><td><input type="text" name="t1" required="required" pattern="[a-zA-Z _]{3,10}" title="please enter only character  between 3 to 10 for donor name" /></td></tr>
 <tr><td>&nbsp;</td></tr>
...
<tr><td class="lefttd" align="center">Mobile No</td><td><input type="number" name="t3"  required="required" pattern="[0-9]{10,12}" title="please enter only numbers between 10 to 12 for mobile no." /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" align="center">Blood Group </td><td>
<select name="blg" required>
...
<tr><td class="lefttd" align="center">E-Mail</td><td><input type="email" name="t5" required="required" /></td></tr>
 <tr><td>&nbsp;</td></tr>
<tr><td class="lefttd" align="center">Required Date</td><td>
<select name="month">
...
if(isset($_POST["sbmt"])) 
{
	...
	$blg=$_POST["blg"];
	$s="insert into requestes(name,gender,age,mobile,bgroup,email,reqdate,detail) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["blg"] . "','" . $_POST["t5"] . "','" . $d .  "','" .  $_POST["t7"]  ."')";
	...
	if($q>0)
	{
	echo "<script>alert('Thank You!!! Accepted Your Request Successfully.');</script>";
	}
	else
